...
class Kernel:
    ...
    def __init__(self):
        ...
        self._botPredicates = {}
        self.setBotPredicate("name", "VIKI-BOT")
        # setting botmaster
    ...
    def bootstrap(self, brainFile = None, learnFiles = [], commands = [],
        ...
        if self._verboseMode:
            pass#print( "Kernel bootstrap completed in %.2f seconds" % (time.process_time() - start) )
    ...
    def learn(self, filename):
        ...
        for f in glob.glob(filename):
            ...
            if self._verboseMode:
                pass#print( "done (%.2f seconds)" % (time.process_time()- start) ) #suppressing the output
